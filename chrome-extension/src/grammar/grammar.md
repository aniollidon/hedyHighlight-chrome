...
(Hi ha un error al salt de línia if/elif/else - WARN?)

# Nivell 7

S'introdueixen mates i decimals
...
- input
- ~~ask~~
- : (no és requerit però cal demanar-lo)
- def
- ~~call~~ --> ()

# Nivell 16

Es poden imprimir llistes
