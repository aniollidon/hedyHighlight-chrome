...
export class HHErrorVal extends HHError {
...
export class HHErrorVals extends HHError {
...
export class HHErrorType extends HHError {
...
export class HHErrorLine extends HHError {
