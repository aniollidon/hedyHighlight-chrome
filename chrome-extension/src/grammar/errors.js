...
const severityAndPriority = {
  ...
  'hy-recommended-equal': { severity: 'info', priority: 0 },
  'hy-recommended-equalequal': { severity: 'info', priority: 0 },
  'hy-recommended-input': { severity: 'info', priority: 0 },
  'hy-recommended-def': { severity: 'info', priority: 0 },
  'hy-recommended-english-color-names': { severity: 'info', priority: 0 },
  'hy-entity-changes-content-type': { severity: 'info', priority: 0 },
  'hy-lines-must-start-with': { severity: 'error', priority: 1 },
  'hy-bracketed-lists-required': { severity: 'warning', priority: 1 },
  ...
  'hy-definition-unexpected-argument': { severity: 'error', priority: 3 },
  ...
  'hy-execting-color-quoted': { severity: 'error', priority: 4 },
  ...
  'hy-atrandom-usage': { severity: 'error', priority: 6 },
  'hy-random-braced-usage': { severity: 'error', priority: 6 },
  ...
  'hy-command-parenthesis-recommended': { severity: 'info', priority: 10 },
  'hy-comma-list-needs-brackets': { severity: 'error', priority: 10 },
  'hy-not-expecting-coma-final': { severity: 'error', priority: 10 },
  ...
  'hy-space-missing-is-and-bracket': { severity: 'warning', priority: 254 },
